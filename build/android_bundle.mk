...
$(ANDROID_BIN)/XCSoar-debug.apk: $(ANDROID_BIN)/XCSoar-debug.aab $(DEBUG_KEYSTORE)
	...
	$(Q)$(BUNDLETOOL) build-apks --overwrite --mode=universal \
		...
		--bundle=$< \
		--output=$(ANDROID_BUILD)/fat_apkset_debug.apks
	$(Q)$(UNZIP) -p $(ANDROID_BUILD)/fat_apkset_debug.apks universal.apk > $@
...
$(ANDROID_BIN)/XCSoar.apk: $(ANDROID_BIN)/XCSoar.aab
	...
	$(Q)$(BUNDLETOOL) build-apks --overwrite --mode=universal \
		...
		--bundle=$< \
		--output=$(ANDROID_BUILD)/fat_apkset_release.apks
	$(Q)$(UNZIP) -p $(ANDROID_BUILD)/fat_apkset_release.apks universal.apk > $@
